...
### FILE CONTAINING ABSTRACT CLASSES AND HELPER FUNCTIONS ###


#An abstact class i inherit when designing my agents. 
#I of course can add more attributes in the class that inherits, more functions, change functions perhaps etc.
class AbstractAgent():
...
#The whole process of running the RL procedure is implemented through the AbstractRLTask
...
#The following two functions only work properly when the observation comes from non terminal (or non dummy) state
